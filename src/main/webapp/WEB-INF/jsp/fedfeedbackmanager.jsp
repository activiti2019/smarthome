...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">反馈信息列表</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" name="formSubmit" onsubmit="return false;" action="${pageContext.request.contextPath }/feedback/feedbacklist.action" method="post">
						&nbsp;&nbsp;&nbsp;
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<p:page url="${pageContext.request.contextPath }/feedback/feedbacklist.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(""!=pagenum){
				document.formSubmit.action="${pageContext.request.contextPath }/feedback/feedbacklist.action?page="+pagenum+"&rows=10";
			}
