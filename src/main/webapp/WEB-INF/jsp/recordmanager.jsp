		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" name="formSubmit" onsubmit="return false;" action="${pageContext.request.contextPath }/record/list.action" method="post">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<p:page url="${pageContext.request.contextPath }/record/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
...
<!-- Bootstrap Core JavaScript -->
	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(""!=pagenum){
				document.formSubmit.action="${pageContext.request.contextPath }/record/list.action?page="+pagenum+"&rows=10";
			}
