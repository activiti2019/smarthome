		...
		<div class="content">
			<ul>
				<li>
					...
					<p>
						<a href="compage/reply.jsp">用户反馈</a><br /> <a
							href="compage/four.jsp">企业介绍</a><br /> <a
							href="compage/four.jsp">企业新闻</a><br />
					</p>
				</li>
				<li>
					<p class="d-ft-l2">&nbsp;</p> APP
					<p>
						<a href="compage/four.jsp">天眼</a><br />
				</li>
				<li>
				...
				<li>
					...
					<p>
						<a href="compage/four.jsp">总裁寄语</a><br /> <a
							href="compage/four.jsp">招贤纳士</a><br /> <a
							href="compage/four.jsp">联系我们</a><br />
					</p>
				</li>
			</ul>
			<p class="weixin">
	...
	<div
		...
		<div
			...
			<span style="float: left;"><a
				...
				href="compage/homepage.jsp">回到首页</a>／<a
				style="color: #fff; text-decoration: none;" href="compage/four.jsp">免责声明</a>／<a
				style="color: #fff; text-decoration: none;" href="compage/four.jsp">友情链接</a></span><span
